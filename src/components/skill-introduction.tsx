...
const SkillItem = ({ children }: { children: React.ReactNode }) => (
    <li className="flex items-start mb-2">
        <span className="flex-shrink-0 w-1.5 h-1.5 mt-1.5 mr-2 bg-black rounded-full"></span>
...
export default function SkillIntroduction() {
    ...
    return (
        <div className="bg-white print:bg-white rounded-lg p-5 print:p-3">
            <h2 className="text-sm font-bold text-gray-800 mb-3 border-b border-gray-300 pb-1">专业技能</h2>
